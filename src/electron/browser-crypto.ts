...
export function createHash(_algorithm: string): HashLike {
  const chunks: Uint8Array[] = [];
  return {
    update(data: string | Uint8Array): HashLike {
      chunks.push(typeof data === "string" ? toBytes(data) : data);
      return this;
    },
    digest(encoding: string = "hex"): string {
      ...
      return encoding === "hex" ? toHex(hash) : String.fromCharCode(...hash);
    },
  };
}
